...
class Vehicle(Location):
    def __init__(self, status, type_of_vehicle, model, rate, manufacturer, condition, age, color, number_plate, driving_license, rent_counter, name_of_airport, country):
    ...
    def __str__(self):
        return "{}, {}, {}, {}, {}, {}, {}, {}, {}, {}, {}, {}, {}".format(self.status, self.type_of_vehicle, self.model, self.rate, self.manufacturer, self.condition, self.age, self.color, self.number_plate, self.driving_license, self.rent_counter, self.name_of_airport, self.country)