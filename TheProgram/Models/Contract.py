class Contracts:
    ...
    def __str__(self):
        return "{:^13s}|{:^13s}|{:^13s}|{:^17s}|{:^17s}|{:^8s}|{:^15s}|{:^16s}|{:^18s}".format(self.date, self.return_date, self.duration, self.name_of_airport, self.employee_name, self.paid, self.final_price, self.number_plate, self.ssn)
