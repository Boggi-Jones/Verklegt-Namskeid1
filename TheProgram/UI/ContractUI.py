...
class ContractUI():
 ...
 -----------------------------------------------------------------------------
 | Choose attribute to change or press 'q' to go back: '''.format(the_contract[0].date, the_contract[0].return_date,customer[0].gsm_number,customer[0].email,customer[0].address,customer[0].driving_license,the_contract[0].number_plate))
